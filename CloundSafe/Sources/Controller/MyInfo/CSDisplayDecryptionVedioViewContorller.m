//
//  CSDisplayDecryptionVedioViewContorller.m
//  CloundSafe
//
...
static NSString * const reuseIdentifier = @"DecryptionVedioCell";

@implementation CSDisplayDecryptionVedioViewContorller
