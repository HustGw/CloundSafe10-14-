//
//  CSEncryptionImageViewController.m
//  CloundSafe
//
...
@interface CSEncryptionImageViewController ()<CSFullScreenPictureDisplayDelegate, UICollectionViewDelegate, UICollectionViewDataSource, MWPhotoBrowserDelegate>
...
@implementation CSEncryptionImageViewController
static NSString * const reuseIdentifier = @"EncryptionImageCell";
- (void)viewDidLoad
{
    [super viewDidLoad];
    self.title = @"图片";
